...
@WebServlet(name = "ShowUserPageImage",
        urlPatterns = {"/ShowUserPageImage"})
public class ShowUserPageImage extends HttpServlet {
...
//    private static Map<Long, Byte[]> imageMap = new HashMap();
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            UserPageComponent userPageComponent = (UserPageComponent) getServletContext().getAttribute("userPageComponent");
            byte[] image;
